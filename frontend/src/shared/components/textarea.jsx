...
export const Textarea = forwardRef(function Textarea({ className, readOnly=false, resizable=true, dark=true, ...props }, ref) {
  return (
    <span
      data-slot="control"
      className={clsx([
    ...
    >
      <Headless.Textarea
        ...
        className={clsx([
          ...
          // Dark mode
          dark && 'dark:bg-white/5 dark:text-white dark:border-white/10 dark:data-hover:border-white/20',
        ])}
      />
    </span>
  )
