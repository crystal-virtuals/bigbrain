...
const HTTPErrors = {
  403: {
    ...
    message: "Sorry, the page you were trying to reach is absolutely forbidden for some reason.",
  },
  404: {
    statusCode: 404,
...
function ErrorPage({ statusCode, statusText, message }) {
  return (
    <>
      <div className="grid min-h-full grid-cols-1 grid-rows-[1fr_auto_1fr] lg:grid-cols-[max(50%,36rem)_1fr]">
        ...
        <main className="mx-auto w-full max-w-7xl px-6 py-24 sm:py-32 lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:px-8">
          <div className="max-w-lg">
            <span className="text-base/8 font-semibold text-accent">{statusCode}</span>
