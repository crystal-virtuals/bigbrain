import { CreateGameModal } from '@components/game';
...
export default function EmptyState({ onCreate }) {
  ...
  return (
    <>
      <CreateGameButton onCreate={() => setIsOpen(true)} />
      <CreateGameModal isOpen={isOpen} setIsOpen={setIsOpen} onSubmit={onCreate} />
    </>
  );
}

function CreateGameButton({ onCreate }) {
  const styles = [
    // Base
